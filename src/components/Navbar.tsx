...
export function Navbar() {
  return (
    <div className='flex items-center justify-between p-4 bg-transparent'>
      <img src={logo} alt='Saudi Controls' className='h-16 md:h-20' />
      <NavigationMenu>
        <NavigationMenuList className='flex flex-col md:flex-row'>
          <NavigationMenuItem>
            <NavigationMenuTrigger className={cn(navigationMenuTriggerStyle(), 'bg-transparent hover:bg-transparent')}>
              <p className='text-white'>Getting started</p>
            </NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className='grid gap-3 p-4 md:max-w-[400px] lg:max-w-[500px] lg:grid-cols-[.75fr_1fr]'>
